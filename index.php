...
<div class="popup-content">
    ...
    <p id="popup-message">
        <i class="far fa-clock"></i> Time: <span id="popup-time">0</span>s<br>
        <i class="fas fa-times-circle"></i> Errors: <span id="popup-errors">0</span><br>
        <i class="fas fa-tachometer-alt"></i> WPM: <span id="popup-wpm">0</span><br>
        <i class="fas fa-keyboard"></i> CPM: <span id="popup-cpm">0</span><br>
        <i class="fas fa-bullseye"></i> Accuracy: <span id="popup-accuracy">0%</span>
    </p>
            ...
            .then(data => {
                ...
                if (data.error) {
                    ...
                    data.forEach(result => {
                        const li = document.createElement('li');
                        li.innerHTML = `
                            <i class="fas fa-tachometer-alt"></i> WPM: ${result.wpm}, 
                            <i class="fas fa-keyboard"></i> CPM: ${result.cpm}, 
                            <i class="fas fa-bullseye"></i> Accuracy: ${result.accuracy}%, 
                            <i class="fas fa-times-circle"></i> Errors: ${result.errors}, 
                            <i class="far fa-clock"></i> Time: ${parseFloat(result.time).toFixed(2)}s
                        `;
                        historyList.appendChild(li);
                    });
                }
